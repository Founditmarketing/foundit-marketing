    ...
    <footer className="bg-background text-foreground pt-20 pb-10 relative overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-6 relative z-10">
        <motion.div
          ...
          className="lg:grid lg:grid-cols-12 gap-12 items-center bg-card/40 backdrop-blur-3xl p-12 lg:p-24 rounded-[4rem] mb-32 border border-border/50 shadow-3xl overflow-hidden relative group"
        >
          ...
          <div className="lg:col-span-8 relative z-10">
            ...
            <h2 className="text-5xl lg:text-[5.5rem] font-black mb-10 uppercase italic tracking-tighter leading-[0.9] text-foreground">
              We Don't Do Campaigns. <br />
              <span className="text-primary drop-shadow-[0_0_15px_rgba(249,115,22,0.3)]">We Build Empires.</span>
            </h2>
            <p className="text-xl lg:text-3xl text-muted-foreground max-w-2xl font-medium italic border-l-8 border-primary pl-10 leading-relaxed opacity-80">
