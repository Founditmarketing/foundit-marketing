    ...
    <main className="bg-transparent text-foreground py-24 lg:py-48 relative overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-6 relative z-10">
        ...
        <div className="text-center py-24 relative px-4">
          ...
          <h2 className="text-oversized mb-12 opacity-10 text-white select-none">SCALE.</h2>
          <Button
            asChild
          ...
          >
            <Link href="/contact?problem=google" className="flex items-center justify-center w-full">Build Your Empire</Link>
          </Button>
        </div>
      </div>
    </main>
