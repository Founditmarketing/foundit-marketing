        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 lg:gap-24 pb-24">
          ...
          <div className="md:col-span-12 lg:col-span-6 grid grid-cols-1 sm:grid-cols-3 gap-10">
            <div className="space-y-6">
              <h4 className="font-black text-[10px] uppercase tracking-[0.4em] text-primary opacity-60">Strategic Lab</h4>
            ...
            <div className="space-y-6">
              <h4 className="font-black text-[10px] uppercase tracking-[0.4em] text-primary opacity-60">Intelligence</h4>
              <ul className="space-y-4 flex flex-col items-start">
            ...
            <div className="space-y-6">
              <h4 className="font-black text-[10px] uppercase tracking-[0.4em] text-primary opacity-60">Presence</h4>
              <ul className="space-y-4 flex flex-col items-start">
                <li><Link href="/marketing-alexandria" className="text-sm md:text-base font-black hover:text-primary transition-all tracking-widest uppercase inline-block">Alexandria</Link></li>
                <li><Link href="/pineville-seo" className="text-sm md:text-base font-black hover:text-primary transition-all tracking-widest uppercase inline-block">Pineville</Link></li>
                <li><Link href="/central-louisiana-web-design" className="text-sm md:text-base font-black hover:text-primary transition-all tracking-widest uppercase inline-block">Cenla Design</Link></li>
              </ul>
            </div>
          </div>
